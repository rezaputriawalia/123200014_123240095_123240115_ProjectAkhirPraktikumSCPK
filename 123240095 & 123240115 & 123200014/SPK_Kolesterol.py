...
# DESKRIPSI DINAMIS
# ==================================================
def deskripsi_fat(val):
    if val <= 5:
        return "Kadar lemak rendah dan lebih aman untuk penderita kolesterol."
    elif val <= 15:
        return "Kadar lemak berada pada tingkat sedang dan masih perlu diperhatikan."
    else:
        return "Kadar lemak tinggi dan kurang baik untuk penderita kolesterol."

def deskripsi_fiber(val):
    if val <= 2:
        return "Asupan serat masih rendah dan kurang optimal untuk membantu mengontrol kolesterol."
    elif val <= 5:
        return "Asupan serat berada pada tingkat sedang."
    else:
        return "Asupan serat tinggi dan baik untuk membantu menjaga kadar kolesterol."

def deskripsi_sodium(val):
    if val <= 150:
        return "Kadar sodium rendah dan lebih aman untuk pola makan sehat."
    elif val <= 500:
        return "Kadar sodium berada pada tingkat sedang dan perlu dikontrol."
    else:
        return "Kadar sodium tinggi dan sebaiknya dibatasi."

def deskripsi_cholesterol(val):
    if val <= 20:
        return "Kadar kolesterol rendah dan lebih aman untuk dikonsumsi."
    elif val <= 80:
        return "Kadar kolesterol berada pada tingkat sedang."
    else:
        return "Kadar kolesterol tinggi dan kurang baik untuk penderita kolesterol."
    ...
    if proses:
        ...
        with col1:
            ...
            <div class="nutrisi-card">
                ...
                <div class="nutrisi-body">
                    ...
                    <p>{deskripsi_sodium(sodium_input)}</p>
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            <div class="nutrisi-card">
                ...
                <div class="nutrisi-body">
                    <h3>{fiber_input} g</h3>
                    <p>{deskripsi_fiber(fiber_input)}</p>
                </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            <div class="nutrisi-card">
                ...
                <div class="nutrisi-body">
                    ...
                    <p>{deskripsi_cholesterol(kolesterol_input)}</p>
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        # ==================================================
        # FILTER MAKANAN SESUAI KONDISI PASIEN
        # ==================================================
        filtered_foods = foods[
            (foods['Fat (g)'] <= fat_input) &
            (foods['Fiber (g)'] >= fiber_input) &
            (foods['Sodium (mg)'] <= sodium_input) &
            (foods['Cholesterol (mg)'] <= kolesterol_input)
        ]
        ...
        # ==================================================
        results = []
        for index, row in filtered_foods.iterrows():
            try:
        ...
        # REKOMENDASI MAKANAN
        # ==================================================
        st.markdown("## 🩺 Kondisi Nutrisi Pasien")
        st.info(f"""
        Berdasarkan kondisi pasien:

        - Lemak: {fat_input} g
        - Serat: {fiber_input} g
        - Sodium: {sodium_input} mg
        - Kolesterol: {kolesterol_input} mg

        Sistem akan menampilkan makanan yang paling sesuai
        dengan kondisi nutrisi pasien penderita kolesterol.
        """)
